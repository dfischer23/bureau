# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-01-11 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('active', 'Aktiv'), ('alumnus', 'alumn'), ('waitlisted', 'auf der Warteliste'), ('intent_declared', 'intent declared'), ('in_admission_procedure', 'in admission procedure'), ('rejected', 'abgesagt')], max_length=20, null=True, verbose_name='Status')),
                ...
                ('planned_enrollment', models.CharField(blank=True, max_length=200, null=True, verbose_name='Geplante Einschulung (und Alter)')),
