# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-01-13 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('on_address_list', models.BooleanField(default=True, verbose_name='In der Adressliste anzeigen')),
                ('is_teammember', models.BooleanField(default=False, verbose_name='Teammitglied')),
                ('team_email_address', models.CharField(blank=True, max_length=128, verbose_name='Infinita-EMail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('active', 'Aktiv'), ('in_admission_procedure', 'Bewerbungsverfahren'), ('waitlisted', 'Warteliste'), ('intent_declared', 'Absichtserklärung'), ('cancelled', 'abgesagt/abgelaufen'), ('alumnus', 'Ehemalig'), ('special', 'Ausnahme')], max_length=32, null=True, verbose_name='Status')),
                ...
                ('language', models.CharField(blank=True, default='Deutsch', max_length=200, verbose_name='Sprache im Elternhaus')),
                ('first_day', models.DateField(blank=True, null=True, verbose_name='Erster Tag an dieser Schule')),
                ('last_day', models.DateField(blank=True, null=True, verbose_name='Letzter Tag an dieser Schule')),
                ...
                ('district_school', models.CharField(blank=True, max_length=200, null=True, verbose_name='Einzugsschule')),
                ('after_school_care', models.BooleanField(default=False, verbose_name='in Nachmittagsbetreuung')),
                ...
                ('planned_enrollment_year', models.CharField(blank=True, max_length=32, null=True, verbose_name='Einschulungsjahr')),
                ('planned_enrollment_age', models.CharField(blank=True, max_length=32, null=True, verbose_name='Einschulungsalter')),
                ('application_note', models.CharField(blank=True, max_length=500, null=True, verbose_name='Anmerkung zur Bewerbung')),
                ('waitlist_position', models.IntegerField(blank=True, null=True, verbose_name='Position Warteliste')),
                ('application_received', models.NullBooleanField(verbose_name='Bewerbung erhalten')),
                ('obligatory_conference', models.NullBooleanField(verbose_name='Obl. EA')),
                ('parent_dialog', models.CharField(blank=True, max_length=32, null=True, verbose_name='Elterngespräch')),
                ('confirmation_status', models.CharField(blank=True, max_length=32, null=True, verbose_name='(vorl.) Zusage')),
                ('sitting', models.CharField(blank=True, max_length=32, null=True, verbose_name='Hospitation')),
